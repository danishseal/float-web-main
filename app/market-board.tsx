...
export default function MarketBoard({ view = "markets" }: { view?: "markets" | "top200" }) {
  ...
  return <div className="float-content">
    ...
    <p className="float-disclaimer">Quotes, market caps and optional advanced charts by TradingView. Market caps are live, in USD, and refresh every minute alongside the quotes. Line charts show six months of daily closing prices from Yahoo Finance. Prices use the listing’s currency. Six-month returns come from the latest provider data. Updates follow exchange trading hours and may be delayed. Which companies appear here, and the order they appear in, come from the September 1, 2026 reference list.</p>
  </div>;
}
